<?php get_header(); ?>
    ...
    <div class="slider" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/hero_img1.jpg);">
      <div class="sliderfilter">
        <div class="container slidercontent">
          ...
          <div class="call">
            <a href="<?php echo get_site_url(); ?>/servicios"><span>Conoce más sobre nuestros servicios</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="section">
    <div class="landing_footer">
      <p class="hero_footer oscuro bold">¡Es momento de viajar!</p>
      <p class="p_captions oscuro">Conoce más sobre nosotros</p>
      <span
        class="iconify arrow_down_icon"
        data-icon="fluent:chevron-down-20-filled"
        data-inline="false"
        style="color: #061a23"
        widht="2rem"
        height="2rem"
  ...
  <div class="section bg">
    ...
    <div class="container">
      ...
      <h1 class="side">¿Quienes somos?</h1>
        ...
        <a class="sidebutton" href="<?php echo get_site_url(); ?>/sobre-nosotros">Ver más</a>
  ...
  <div class="section bg">
    <div class="container">
      ...
      <div class="col three bg nopad pointer">
        <img class="imgholder" src="<?php echo get_template_directory_uri().'/img/gallery_1.jpg'; ?>" alt="" />
        <h2>WOW</h2>
        <p class="oscuro">wow</p>
      </div>

      <div class="col three bg nopad pointer">
        <img class="imgholder" src="<?php echo get_template_directory_uri().'/img/gallery_2.jpg'; ?>" alt="" />
        <h2>WOW</h2>
        <p class="oscuro">wow</p>
      </div>

      <div class="col three bg nopad pointer">
        <img class="imgholder" src="<?php echo get_template_directory_uri().'/img/gallery_3.jpg'; ?>" alt="" />
        <h2>WOW</h2>
        <p class="oscuro">wow</p>
      </div>

      <div class="col three bg nopad pointer">
        <img class="imgholder" src="<?php echo get_template_directory_uri().'/img/gallery_4.jpg'; ?>" alt="" />
        <h2>WOW</h2>
        <p class="oscuro">wow</p>
      </div>

      <div class="col three bg nopad pointer">
        <img class="imgholder" src="<?php echo get_template_directory_uri().'/img/gallery_5.jpg'; ?>" alt="" />
        <h2>WOW</h2>
        <p class="oscuro">wow</p>
      </div>

      <div class="col three bg nopad pointer">
        <img class="imgholder" src="<?php echo get_template_directory_uri().'/img/gallery_6.jpg'; ?>" alt="" />
        <h2>WOW</h2>
        <p class="oscuro">wow</p>
      </div>
  ...
  <div class="section servicesbg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/services_img.jpg);">
    <div class="servicesbgfilter">
      ...
      <div class="container">
        <a class="p_captions button_container" href="<?php echo get_site_url(); ?>/servicios">Ver más sobre nuestros servicios</a>
      </div>
    </div>
  </div>
  <?php get_footer(); ?>